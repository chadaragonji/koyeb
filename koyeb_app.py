...
class Proxy:
    ...
    def run(self, host, port):
        ...
        print(f"\x1B[32m[\x1B[37m{current_today}{current_time}\x1B[32m] You socks ip address (localhost): {host}:{portx}\x1B[37m")
...
if __name__ == "__main__":
    ...
    if CONSOLE == "on" or CONSOLE == "On" or CONSOLE == "ON" or CONSOLE == "True" or CONSOLE == "true":
        ...
        proxy_console.start()
    proxy = Proxy()
    proxy.run("0.0.0.0", portx)


#pip install PySocks pick requests
